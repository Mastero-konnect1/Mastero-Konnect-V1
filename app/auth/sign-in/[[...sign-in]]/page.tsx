          ...
          <CardContent className="p-8">
              ...
              appearance={{
                elements: {
                  ...
                  socialButtonsBlockButton: `
                    !w-full !border-2 !border-gray-200 !hover:border-blue-500 
                    !bg-white !hover:bg-blue-50 !text-gray-900 !font-semibold 
                  ...
                  // ✅ LABELS - SIMPLE BLUE (NO GRADIENT)
                  formFieldLabel: `
            ...
            <div className="pt-6 border-t border-gray-200 text-center">
              ...
              <Button asChild className="w-full h-12 rounded-xl border-2 border-gray-200">
                <a href="/auth/sign-up" className="font-semibold text-base">Create Account</a>
              </Button>
            </div>
          </CardContent>
        </Card>
