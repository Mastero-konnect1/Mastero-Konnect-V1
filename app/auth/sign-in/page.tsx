  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center" style={{ backgroundColor: '#0d47ff' }}>
      ...
      >
        ...
        <div 
          className="absolute top-0 bottom-0 w-1/2 bg-white transition-all duration-600 flex items-center justify-center"
          style={{
            left: isSignUp ? '50%' : '0',
        ...
        >
          {!isSignUp ? (
            // Login Form
            <div className="px-20 py-16 w-full animate-in fade-in duration-500">
              <div className="mb-8">
              ...
              <Button 
                ...
                style={{ backgroundColor: '#0d47ff', color: '#ffffff' }}
              >
                LOG IN
              </Button>
              ...
              <div className="flex justify-center gap-4">
                <button className="w-10 h-10 rounded-lg border flex items-center justify-center transition-all hover:bg-gray-50" style={{ borderColor: '#d1d5db' }}>
            ...
            <div className="px-16 py-16 text-center animate-in fade-in duration-500">
              ...
              <div className="flex flex-col items-center justify-center h-full">
                ...
                <Button
                  ...
                  className="w-[120px] h-[42px] rounded-lg font-medium text-[15px] bg-transparent border-2 border-white text-white hover:bg-white transition-all"
                  style={{ 
                    color: '#ffffff',
                    borderColor: '#ffffff'
                  }}
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.color = '#0d47ff'
                  }}
                  onMouseLeave={(e) => {
        ...
        <div 
          className="absolute top-0 bottom-0 w-1/2 transition-all duration-600 flex items-center justify-center"
          style={{
            right: isSignUp ? '50%' : '0',
