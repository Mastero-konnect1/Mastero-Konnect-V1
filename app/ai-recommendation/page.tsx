      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row gap-4 max-w-5xl mx-auto">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="p-2 rounded-lg border border-gray-300 m-1"
            >
          ...
          <Card className="relative overflow-hidden group transition-transform duration-300 hover:scale-105 border-[3px] border-gradient-to-br from-blue-200 to-blue-400 shadow-[0_4px_6px_rgba(0,0,0,0.1)] bg-white">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
              ...
              <CardContent className="p-6 flex flex-col justify-between h-full">
                ...
                <div>
                  <div className="mb-6">
                    <h2 className="text-3xl font-bold text-mastero-dark">{bestMatch.name}</h2>
                    <p className="text-xl text-gray-700 font-semibold mb-1">{bestMatch.title}</p>
                  ...
                  <div className="mb-6 space-y-2">
                    ...
                    <p className="text-sm text-gray-600">
                      <span className="font-semibold text-gray-800">Specialties:</span> {bestMatch.specialties.join(", ")}
                    </p>
                  </div>
                  <div className="flex items-center justify-between mt-4 border-t pt-4 text-gray-600">
                    <div className="flex items-center gap-2">
                      <Star className="w-5 h-5 fill-yellow-400 text-yellow-400" />
                      <span className="text-lg font-bold text-mastero-dark">{bestMatch.rating}</span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium">{bestMatch.yearsExperience} Years Exp.</span>
                    </div>
                  </div>
                </div>
                ...
                <Button
                  size="lg"
                  className={`bg-mastero-blue text-white hover:bg-mastero-blue-dark w-full py-3 transition-all duration-300 mt-6 ${
        ...
        <div className="text-center">
          <Button
            ...
            // onClick={}
          >
            <Link href={"/find-mentor"} >Browse All Mentors
            </Link>
