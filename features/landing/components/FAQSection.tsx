...
//     <section 
//       ref={sectionRef}
//       className={`py-20 faq-section ${entered ? 'entered' : ''}`} 
//       style={{ 
//         background: 'white',
//         minHeight: '100vh',
//       }}
...
//           .faq-section, .faq-item, .faq-arrow, .cta-button {
...
//               marginBottom: '2rem'
//             }}>
//               Everything you need to know about InnovKaro mentorship platform. 
  ...
  return (
    ...
    >
      <style>{`
        ...
        .faq-item:hover {
          background: linear-gradient(to bottom, rgba(59, 130, 246, 0.15), rgba(147, 51, 234, 0.15), rgba(236, 72, 153, 0.15));
          transform: translateX(0) scale(1.02);
        }
          ...
          <div style={{ paddingTop: '2rem' }}>
            ...
            <div style={{
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = '#3b82f6'
                e.currentTarget.style.color = '#3b82f6'
                e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(59, 130, 246, 0.05), rgba(147, 51, 234, 0.05), rgba(236, 72, 153, 0.05))'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = '#e5e7eb'
                e.currentTarget.style.color = '#1f2937'
              ...
              <button className="cta-button" style={{
                padding: '1rem 2rem',
                background: 'linear-gradient(to bottom, rgba(59, 130, 246, 0.8), rgba(147, 51, 234, 0.8), rgba(236, 72, 153, 0.8))',
                color: 'white',
                border: 'none',
                borderRadius: '12px',
                fontSize: '1rem',
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(59, 130, 246, 0.9), rgba(147, 51, 234, 0.9), rgba(236, 72, 153, 0.9))'
                e.currentTarget.style.boxShadow = '0 8px 15px rgba(59, 130, 246, 0.4)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(59, 130, 246, 0.8), rgba(147, 51, 234, 0.8), rgba(236, 72, 153, 0.8))'
                e.currentTarget.style.boxShadow = '0 4px 6px rgba(59, 130, 246, 0.3)'
              }}
              >
                Get Started
          ...
          <div style={{
            ...
            {faqs.slice(0, 6).map((faq, index) => (
              <div
                ...
                style={{
                  transitionDelay: `${index * 100}ms`,
                  background: 'linear-gradient(to bottom, rgba(59, 130, 246, 0.3), rgba(147, 51, 234, 0.3), rgba(236, 72, 153, 0.3))',
                  borderRadius: '16px',
                  padding: '1.5rem',
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(59, 130, 246, 0.4), rgba(147, 51, 234, 0.4), rgba(236, 72, 153, 0.4))'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = '0 4px 12px rgba(0,0,0,0.06)'
                  e.currentTarget.style.background = 'linear-gradient(to bottom, rgba(59, 130, 246, 0.3), rgba(147, 51, 234, 0.3), rgba(236, 72, 153, 0.3))'
                }}
                onClick={() => {
                  // Show answer on click
                  const answer = faq.answer;
                  alert(`Q: ${faq.question}\n\nA: ${answer}`);
                }}
              >
                ...
                <div style={{
                  ...
                  right: 0,
                  height: '2px',
                  background: 'linear-gradient(to right, rgba(59, 130, 246, 0.8), rgba(147, 51, 234, 0.8), rgba(236, 72, 153, 0.8))'
                }}></div>
                ...
                {/* Hidden answer that appears on hover (optional) */}
                <div style={{
                  marginTop: '0.75rem',
                  fontSize: '0.875rem',
                  color: '#4b5563',
